...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (intero notmuch general avy which-key counsel ivy company-quickhelp company auctex company-auctex smartparens projectile smart-mode-line smart-mode-lie use-package solarized-theme powerline-evil magit helm))))
(custom-set-faces
